...
public class Level_13_Soft_Assert extends BaseTest {
    ...
    public void TC_01_Login_Empty_Email_Password() {
        ...
        softAssert.assertFalse(driver.findElement(By.xpath("//button[@title='Subscribe']")).isDisplayed());
        ...
        softAssert.assertFalse(driver.findElement(By.xpath("//a[@title='Create an Account']")).isDisplayed());
